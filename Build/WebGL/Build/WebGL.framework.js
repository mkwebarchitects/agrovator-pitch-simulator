...
// Begin JS library code
  ...
  function _PitchSimulatorBridge_CancelSubmission(requestId) {
      PitchSimulatorLmsBridge.initialize();
      delete PitchSimulatorLmsBridge.pending[requestId];
    }

  function _PitchSimulatorBridge_GetLaunchConfigJson() {
      PitchSimulatorLmsBridge.initialize();
      return stringToNewUTF8(PitchSimulatorLmsBridge.launchConfigJson);
    }

  
  function _PitchSimulatorBridge_SubmitCompletion(completionJsonPointer, requestId, receiverNamePointer) {
      PitchSimulatorLmsBridge.initialize();
...
var wasmImports = {
  ...
  /** @export */
  PitchSimulatorBridge_CancelSubmission: _PitchSimulatorBridge_CancelSubmission,
  /** @export */

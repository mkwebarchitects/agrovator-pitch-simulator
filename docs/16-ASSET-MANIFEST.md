...
| `Assets/Art/UI/speech-bubble.png` | First-party original | `64x64` nine-slice, `22`px border; navy fill and thin gold border; authored 2026-07-21 for Judge Aya's dialogue bubble; no third-party source, so no redistribution restriction |

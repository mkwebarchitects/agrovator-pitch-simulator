...
| --- | --- | --- | ---: | --- |
| Chrome | `150.0.7871.116` | Passed | `6.716 s` | `artifacts/smoke/chrome-smoke.{json,png}` plus `chrome-tutorial.png` and `chrome-pitch.png` |
| Edge | `150.0.4078.65` | Passed | `6.542 s` | `artifacts/smoke/edge-smoke.{json,png}` |
